...
class eZYuiAjaxContent
{
     ...
     * getInstance
     *
     * @return eZYuiAjaxContent
     */
    public static function getInstance()
    {
        if ( self::$instance === null )
        {
            self::$instance = new eZYuiAjaxContent();
        }
    ...
    {
        if ( is_array( $mix ) )
            return implode(',', array_map( array('eZYuiAjaxContent', 'textEncode'), array_filter( $mix ) ) );
        return $mix;
    }
