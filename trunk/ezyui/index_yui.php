...
function exitWithInternalError( $errorText )
{
    ...
    echo eZYuiAjaxContent::autoEncode( array( 'error_text' => $errorText, 'content' => '' ), $contentType );
...
$_SERVER['SCRIPT_FILENAME'] = str_replace( '/index_yui.php', '/index.php', $_SERVER['SCRIPT_FILENAME'] );
$_SERVER['PHP_SELF'] = str_replace( '/index_yui.php', '/index.php', $_SERVER['PHP_SELF'] );
$_SERVER['REQUEST_URI'] = str_replace( '/index_yui.php', '/index.php', $_SERVER['REQUEST_URI'] );
$_SERVER['SCRIPT_NAME'] = str_replace( '/index_yui.php', '/index.php', $_SERVER['SCRIPT_NAME'] );
