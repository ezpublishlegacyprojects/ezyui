<?php
//
// Definition of eZYuiPackerTemplateFunctions class
//
...
//include_once( 'extension/ezyui/classes/ezyuipacker.php' );

class eZYuiPackerTemplateFunctions
{
    function eZYuiPackerTemplateFunctions()
    {
    }
    ...
    function modify( $tpl, $operatorName, $operatorParameters, $rootNamespace, $currentNamespace, &$operatorValue, $namedParameters )
    {
        ...
        switch ( $operatorName )
        {
            ...
            case 'ezcss':
            {                    
                $ret = eZYuiPacker::buildStylesheetTag( $namedParameters['css_array'],
            ...
            case 'ezscriptfiles':
            {                    
                $ret = eZYuiPacker::buildJavascriptFiles( $namedParameters['script_array'], $packLevel );                    
            } break;
            case 'ezcssfiles':
            {                    
                $ret = eZYuiPacker::buildStylesheetFiles( $namedParameters['css_array'], $packLevel );                    
            } break;
        }
        $operatorValue = $ret;
    }
