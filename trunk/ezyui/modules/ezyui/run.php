...
/* 
 * Brief: eZYui module run
 * A light redirector to be able to run other modules indirectly,
 * when this module has rewrite rules to run under index_yui.php
...
// These functions are only set if called via index_yui.php
if ( !function_exists( 'hasAccessToBySetting' ) )
{
    function exitWithInternalError( $errorText )
    {
        header( $_SERVER['SERVER_PROTOCOL'] . ' 500 Internal Server Error' );
        //include_once( 'extension/ezyui/classes/eyuizajaxcontent.php' );
...
// set global module repositories in case this is called from index_yui.php
